  ...
  <div class="max-w-3xl mx-auto space-y-8">
    ...
    <section class="card p-5 space-y-3">
      ...
      <ul class="list-disc pl-5 space-y-2 text-sm text-neutral-700 dark:text-neutral-300">
        <li>
          <strong>Organizers</strong> create campaigns: dates, target wiki,
          scoring mode, configurable point rules, jury members and suggested
          page lists.
        </li>
        <li>
          <strong>Participants</strong> log in with their Wikimedia account
          and submit articles or Wikidata items. Page metadata — bytes added,
          new-page detection — is verified against the MediaWiki API, never
          trusted from user input.
        </li>
        <li>
          <strong>Juries</strong> score submissions (jury mode), or verify
          participants' point claims (self-assessment and hybrid modes).
        </li>
      </ul>
    </section>

    <section class="card p-5 space-y-3">
      <h2 class="text-lg font-semibold">Scoring modes</h2>
      <table class="w-full">
        <thead>
          <tr class="border-b border-neutral-200 dark:border-neutral-800">
            <th class="th">Mode</th>
            <th class="th">Who counts the points</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
          <tr>
            <td class="td font-mono">jury</td>
            <td class="td">Jurors review every submission; points are the
              average of accepting reviews.</td>
          </tr>
          <tr>
            <td class="td font-mono">self</td>
            <td class="td">Participants claim points under the campaign's
              rules; organizers verify or adjust and always have the final
              say.</td>
          </tr>
          <tr>
            <td class="td font-mono">hybrid</td>
            <td class="td">Self-assessment claims combined with jury
              verification.</td>
          </tr>
        </tbody>
      </table>
      <p class="text-sm text-neutral-600 dark:text-neutral-400">
        Point rules (per-1,000-bytes, substantial improvement, suggested
        pages, quality awards, Wikidata statements, …) are stored per
    ...
    <section class="card p-5 space-y-3">
      ...
      <p class="text-sm text-neutral-700 dark:text-neutral-300">
        Signing in uses MediaWiki OAuth 2.0: WikiSTAR never sees your
        password and stores only your Wikimedia username, the campaigns you
        take part in and the submissions, reviews and claims you make.
      </p>
    </section>
